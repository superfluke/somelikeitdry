...
public abstract class DryGenLayers
{
    /** seed from World#getWorldSeed that is used in the LCG prng */
    private long worldGenSeed;
    /** parent GenLayer that was provided via the constructor */
    protected DryGenLayers parent;
    /**
    ...
    {
    	GenLayer genlayer = new GenLayerDryIsland(1L);
        ...
        if (genSettings != null)
        {
            i = genSettings.biomeSize;
            j = genSettings.riverSize;
        }
        ...
        GenLayer genlayerriver;
        if(!Configs.general.removeRivers)
        	genlayerriver = new GenLayerRiver(1L, genlayer5);
        else
        	genlayerriver = genlayer5;
    ...
    public DryGenLayers(long p_i2125_1_)
    {
